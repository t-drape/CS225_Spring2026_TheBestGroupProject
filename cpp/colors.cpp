...
ostream& operator<<(ostream& os, HSLColor& color) {
    os << "Hue: " << color.hue;
...
ostream& operator<<(ostream& os, RGBColor& color) {
...
double RGBColor::getRedValue() {
    return double(redValue);
}
double RGBColor::getGreenValue() {
    return double(greenValue);
}
double RGBColor::getBlueValue() {
